...
function Header() {
  return (
    <header className="p-6 pb-4 flex flex-col items-center fixed top-0 left-0 right-0 z-50 bg-slate-900/95 backdrop-blur-sm border-b border-white/20 shadow-lg">
      {/* VectorCinema Brand */}
